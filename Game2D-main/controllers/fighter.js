...
export default class Fighter {
     ...
     * }} cfg
     */
    constructor({ name, charKey, x, y, width, height, attacks, maxHealth, assetLoader, audioManager, animationsConfig, attackCooldownBonus = 0 }) {
        this.name = name;
        ...
        this.attackCooldownBonus = attackCooldownBonus;
    ...
    _handleAttackPhases() {
        ...
        if (this.state === 'attack_startup') {
            ...
            if (this.stateTimer >= atk.recovery) {
                this.attackCooldown = atk.startup + atk.active + atk.recovery + (atk.cooldownExtra ?? 0) + this.attackCooldownBonus;
                this.currentAttack = null;
                this.enterState('idle');
            }
        }
